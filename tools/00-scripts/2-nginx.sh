...
docker image tag opcal-nginx:${TAG_VERSION} ${CI_REGISTRY}/opcal/opcal-nginx:${PROJECT_VERSION}-${TIMESTAMP}
...
docker push ${CI_REGISTRY}/opcal/opcal-nginx:${PROJECT_VERSION}-${TIMESTAMP}
