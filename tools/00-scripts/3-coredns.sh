...
docker image tag opcal-coredns:${TAG_VERSION} ${CI_REGISTRY}/opcal/opcal-coredns:${COREDNS_TAG}-${TIMESTAMP}
...
docker push ${CI_REGISTRY}/opcal/opcal-coredns:${COREDNS_TAG}-${TIMESTAMP}
