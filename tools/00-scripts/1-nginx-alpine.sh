...
docker image tag opcal-nginx-alpine:${TAG_VERSION} ${CI_REGISTRY}/opcal/opcal-nginx-alpine:${PROJECT_VERSION}-${TIMESTAMP}
...
docker push ${CI_REGISTRY}/opcal/opcal-nginx-alpine:${PROJECT_VERSION}-${TIMESTAMP}
